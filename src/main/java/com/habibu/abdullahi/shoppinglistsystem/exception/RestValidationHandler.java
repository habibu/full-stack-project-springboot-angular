...
public class RestValidationHandler {
    ...
    public ResponseEntity<FieldValidationErrorDetails> handleValidationError(
            MethodArgumentNotValidException mNotValidException, HttpServletRequest request) {
                ...
                fErrorDetails.setError_detail("Input Filed Validation Failed");
                ...
                for (FieldError error : fieldErrors) {
                    ...
                    List<FieldValidationError> fieldValidationErrorsList = fErrorDetails.getErrors().get(error.getField());
                    if (fieldValidationErrorsList == null) {
                        fieldValidationErrorsList = new ArrayList<FieldValidationError>();
                    }
                    fieldValidationErrorsList.add(fError);
                    fErrorDetails.getErrors().put(error.getField(), fieldValidationErrorsList);
                }
